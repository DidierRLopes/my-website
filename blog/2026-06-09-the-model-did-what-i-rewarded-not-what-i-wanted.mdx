...
<div style={{ display: 'grid', gap: '1rem', gridTemplateColumns: '1fr', margin: '1rem 0 1.25rem' }}>
  <img
    ...
    src="/blog/the-model-did-what-i-rewarded-not-what-i-wanted/the-model-did-what-i-rewarded-not-what-i-wanted-prime-training-run-overview.png"
  ...
  <img
    ...
    src="/blog/the-model-did-what-i-rewarded-not-what-i-wanted/the-model-did-what-i-rewarded-not-what-i-wanted-prime-training-run-metrics.png"
